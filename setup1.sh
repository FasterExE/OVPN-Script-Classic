...
sudo echo '1194' >> /etc/allport/tcp >/dev/null 2>&1
sudo echo '2200' >> /etc/allport/udp >/dev/null 2>&1
sudo echo '80' >> /etc/allport/ws >/dev/null 2>&1
sudo echo '443' >> /etc/allport/ssl >/dev/null 2>&1
